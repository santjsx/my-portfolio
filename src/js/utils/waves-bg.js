/**
 * OFFICIAL WAVES BACKGROUND — React Bits Port (Vanilla JS)
 * This is a direct port of the React Bits Waves component to Vanilla JS.
 */
...
class Waves {
  ...
  bindEvents() {
    ...
    this.onMouseMove = (e) => this.updateMouse(e.clientX, e.clientY);
    this.onTouchMove = (e) => {
...
/**
 * Initializes the Official Waves background effect.
 * @param {string} containerId - The ID of the container element.
 * @param {Object} options - Configuration options for the Waves effect.
 */
export function initWaves(containerId, options = {}) {
  const container = document.getElementById(containerId);
  if (!container) return;

  container.innerHTML = '';
  return new Waves(container, options);
}
